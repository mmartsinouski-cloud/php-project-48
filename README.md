...
[![CI](https://github.com/mmartsinouski-cloud/php-project-48/actions/workflows/ci.yml/badge.svg)](https://github.com/mmartsinouski-cloud/php-project-48/actions/workflows/ci.yml)
...
```bash
# 1. Клонируем
git clone https://github.com/your-username/php-project-48.git
cd php-project-48

# 2. Устанавливаем
composer install

# 3. Запускаем (из папки проекта)
./bin/gendiff file1.json file2.json

# 4. Или добавляем в PATH (один раз)
echo 'export PATH=$PATH:'$(pwd)/bin >> ~/.bashrc
source ~/.bashrc

# 5. Теперь можно запускать отовсюду
